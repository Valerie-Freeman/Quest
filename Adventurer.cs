...
namespace Quest
{
    ...
    public class Adventurer
    {
        ...
        {
            return $"Adventurer, {Name}, is sporting a {ColorfulRobe.Length} inch, {String.Join(" and ", ColorfulRobe.Colors)} robe with a {LuminousHat.ShininessDescription} hat atop their head.";
        }
    }
}